...
def main(video_path, model_type):
    ...
    result, video = transcribe_video.transcribe(video_path, transcribe_video.save_path, transcribe_video.filename, model_type=model_type)
...
if __name__ == '__main__':
    ...
    main(args.video_path, args.model_type)
